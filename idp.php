...
$method = get_method();
if ($method === 'GET') {
    # should not be called because MIndie-Agent does not actually request itself
    # however, this should still return something valuable to whomever ends up here
    require __DIR__ . '/client-id.php'; # maybe redirect instead?
} elseif ($method === 'POST') {
    $type = get_media_type();
